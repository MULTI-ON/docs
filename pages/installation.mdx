...
Welcome to MultiOn — an AI Action Agent designed to automate web tasks using natural language without the need for any APIs.

This guide will help you get started and stay updated with the latest features ✨

## Getting Started with MultiOn

### Step 1: Gain Access

- Join our [Discord](https://discord.gg/multion) and navigate to the **#beta-request** section, or contact a MultiOn team member to whitelist your email for access.
